  ...
  return (
    <div className="relative">
      <div className="relative w-full h-[200px] md:h-[600px]">
        <Image src="/Poster.png" layout="fill" objectFit="cover" alt="Background Image" />
        ...
        <div className="absolute top-1/2 left-1/4 transform -translate-x-1/2 -translate-y-1/2 text-white text-center md:text-left">
          <div className="flex flex-col items-center md:flex-row md:items-center mb-2">
            <h1 className="text-2xl md:text-4xl mb-2 md:mb-0 mr-2">John Wick: Chapter 4</h1>
          ...
          American neo-noir action thriller film directed and co-produced by Chad Stahelski and written by Shay Hatten and Michael Finch
          </p>
          <button className="bg-red-800 text-white px-4 py-2 rounded-full hover:bg-red-700 flex items-center text-xl hover:scale-110 ease-in duration-300 font-medium"> <BsFillPlayCircleFill size={25} className="mr-1" />WATCH TRAILER</button>
        </div>
      </div>
    </div>
  );
